...
insn_desc_t instructions[256] = {
    ...
    INSN_ENTRY(0x1, 1, 12, IMP_insn_ld_16s),
    INSN_ENTRY(0x2, 1, 8, IMP_insn_store_A),
    INSN_ENTRY(0x3, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0x4, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x5, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x6, 1, 8, IMP_insn_ld_immediate),
    INSN_ENTRY(0x7, 1, 4, IMP_rot_left),
    INSN_ENTRY(0x8, 1, 20, IMP_insn_ld_16s),
    INSN_ENTRY(0x9, 1, 8, IMP_insn_add_regs),
    INSN_ENTRY(0xa, 1, 8, IMP_insn_ld_indirect),
    INSN_ENTRY(0xb, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0xc, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0xd, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0xe, 1, 8, IMP_insn_ld_immediate),
    INSN_ENTRY(0xf, 1, 4, IMP_rot_right),
    INSN_ENTRY(0x10, 1, 4, IMP_stop_0x10),
    INSN_ENTRY(0x11, 1, 12, IMP_insn_ld_16s),
    INSN_ENTRY(0x12, 1, 8, IMP_insn_store_A),
    INSN_ENTRY(0x13, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0x14, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x15, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x16, 1, 8, IMP_insn_ld_immediate),
    INSN_ENTRY(0x17, 1, 4, IMP_rot_left),
    INSN_ENTRY(0x18, 1, 8, IMP_jump_rel),
    INSN_ENTRY(0x19, 1, 8, IMP_insn_add_regs),
    INSN_ENTRY(0x1a, 1, 8, IMP_insn_ld_indirect),
    INSN_ENTRY(0x1b, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0x1c, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x1d, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x1e, 1, 8, IMP_insn_ld_immediate),
    INSN_ENTRY(0x1f, 1, 4, IMP_rot_right),
    INSN_ENTRY(0x20, 1, 8, IMP_jump_rel),
    INSN_ENTRY(0x21, 1, 12, IMP_insn_ld_16s),
    INSN_ENTRY(0x22, 1, 8, IMP_insn_store_A),
    INSN_ENTRY(0x23, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0x24, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x25, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x26, 1, 8, IMP_insn_ld_immediate),
    INSN_ENTRY(0x27, 1, 4, IMP_insn_daa),
    INSN_ENTRY(0x28, 1, 8, IMP_jump_rel),
    INSN_ENTRY(0x29, 1, 8, IMP_insn_add_regs),
    INSN_ENTRY(0x2a, 1, 8, IMP_insn_ld_indirect),
    INSN_ENTRY(0x2b, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0x2c, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x2d, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x2e, 1, 8, IMP_insn_ld_immediate),
    INSN_ENTRY(0x2f, 1, 4, IMP_cpl),
    INSN_ENTRY(0x30, 1, 8, IMP_jump_rel),
    INSN_ENTRY(0x31, 1, 12, IMP_insn_ld_16s),
    INSN_ENTRY(0x32, 1, 8, IMP_insn_store_A),
    INSN_ENTRY(0x33, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0x34, 1, 12, IMP_insn_incr8),
    INSN_ENTRY(0x35, 1, 12, IMP_insn_incr8),
    INSN_ENTRY(0x36, 1, 12, IMP_insn_ld_immediate),
    INSN_ENTRY(0x37, 1, 4, IMP_scf),
    INSN_ENTRY(0x38, 1, 8, IMP_jump_rel),
    INSN_ENTRY(0x39, 1, 8, IMP_insn_add_regs),
    INSN_ENTRY(0x3a, 1, 8, IMP_insn_ld_indirect),
    INSN_ENTRY(0x3b, 1, 8, IMP_insn_incdec16),
    INSN_ENTRY(0x3c, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x3d, 1, 4, IMP_insn_incr8),
    INSN_ENTRY(0x3e, 1, 8, IMP_insn_ld_immediate),
    INSN_ENTRY(0x3f, 1, 4, IMP_ccf),
    ...
    INSN_ENTRY(0xf9, 1, 8, IMP_insn_ld_16s),
